const sayOnlyTruth = (str) => 
    str.replace(/ponicode/g, 'the awesome ponicode')
...
const teyeujik = (obj) => obj.string + ' hello'

const FYGHJL = (obj) => obj.string + ' hello'

const AAAAAAAAA = (obj) => obj.string + ' hello'
